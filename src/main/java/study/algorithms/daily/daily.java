...
//        }
     ...
     */
    public static int step16(int num, int n) {
        return num % n == 0 ? 1 : 0;
    }
     ...
     */
    public static int step17(int number, int n, int m) {
     ...
     */
    public static int step18(int n) {
        int answer = 0;
        if (n % 2 == 0) {
            for (int i = 2; i <= n; i += 2) {
                answer += i * i;
     ...
     */
    public static int step19(String ineq, String eq, int n, int m) {
        boolean a;
        if (ineq.equals(">")) {
            a = eq.equals("=") ? n >= m : n > m;
        } else {
     ...
     */
    public static int step20(int a, int b, boolean flag) {
        return flag ? a+b : a-b;
    }
}
